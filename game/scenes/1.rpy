label prologue:
    ...
    thought "The results are posted on the wall."
    thought "Everyone crowds around it."
    thought "I already know before I even look."
    thought "I can feel it."
    thought "That specific kind of dread that sits in your chest like a stone."

    thought "Please."
    thought "Please just let me be okay this once."

    thought "I find my name."
    thought "I stare at the number beside it for a long time."
    thought "The hallway noise fades out."
    thought "Someone laughs nearby."
    thought "Someone else says they got a 94."
    thought "We watched a movie together last night."
    thought "All of us."
    thought "And I was the only one who came in today already knowing I'd failed."
    ...
    thought "Or maybe I have and I just stopped letting myself."
    thought "I used to tease him about his robot drawings."
    thought "I used to say mine were better."
    thought "He always agreed."
    thought "I used to tease him ab—"
